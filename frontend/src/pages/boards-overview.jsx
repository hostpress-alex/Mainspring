            ...
            <div className='overview-main'>
                <div className='overview-head'>
                    ...
                    <div className='overview-actions'>
                        <input className='overview-search' placeholder={t('board.search')} value={filter}
                            ...
                            return (
                                <Link key={board._id} to={`/board/${board._id}`} className='overview-card'>
                                    <div className='overview-card-title'>
                                        {isOwner && <span title={t('board.youAreOwner')} className='overview-owner-star'>★</span>}
                                        {board.title}
                                    </div>
                                    ...
                                    <div className='overview-avatars'>
                                        ...
                                        {members.length === 0 && <span className='overview-no-members'>{t('board.noMembers')}</span>}
                                    </div>
                                </Link>
                            )
                        })}

        ...
        <div className="login-signup">
            ...
            <form className="form-container layout" onSubmit={(ev) => onSubmit(ev, isSignup)}>
                ...
                <div className="suggest-signup">
                    ...
                    {!isSignup && <Link to={'/auth/signup'}><button className="btn-signup" onClick={toggleSignup}>{t('login.signup')}</button></Link>}
                    {isSignup && <Link to={'/auth/login'}><button className="btn-signup" onClick={toggleSignup}>{t('nav.login')}</button></Link>}
                </div>
            </form>
        </div>
    )

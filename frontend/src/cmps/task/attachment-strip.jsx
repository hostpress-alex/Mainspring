            ...
            <div className='attachment-strip'>
                {attachments.map(a => isImage(a) ? (
                    <div key={a._id} className='attachment-thumb-wrap'>
                        <img src={a.url} alt={a.name || ''} title={a.name || ''} className='attachment-thumb'
                            onClick={() => setLightbox(a)} />
                        {onRemove && (
                            <button type='button' className='attachment-remove' title={t('common.remove')}
                    ...
                    <a key={a._id} href={a.url} target='_blank' rel='noreferrer' className='attachment-file'>
                        ...
                        {onRemove && (
                            <button type='button' className='attachment-remove is-inline'

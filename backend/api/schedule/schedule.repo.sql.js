/**
 * Speicherzugriff auf Kalendereintraege — MariaDB.
 * Gegenstueck: schedule.repo.mongo.js.
 *
 * start/end heissen in der Datenbank start_at/end_at: END ist ein
 * reserviertes Wort in SQL.
 */

...
async function getEntries(req, res){
    try {
        ...
        fail(res, err, 'Kalender konnte nicht geladen werden')
    }
}
...
async function addEntry(req, res){
    try {
        ...
        fail(res, err, 'Eintrag konnte nicht angelegt werden')
    }
}
...
async function updateEntry(req, res){
    try {
        ...
        fail(res, err, 'Eintrag konnte nicht gespeichert werden')
    }
}
...
async function removeEntry(req, res){
    try {
        ...
        fail(res, err, 'Eintrag konnte nicht geloescht werden')
    }
}
